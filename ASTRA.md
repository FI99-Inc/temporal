...
**Current task:** 1.8 Implement proof-v1 pressure with structured reasons

**Status:** Gate 0 complete; Tasks 1.1–1.7 complete; Task 1.8 next
...
Resume **1.8 Implement proof-v1 pressure with structured reasons** in `docs/BUILD-GATES.md`, against `docs/DOMAIN-CONTRACT.md` version 1 and the validated S01–S16 fixture harness. Complete and verify each numbered task before committing and advancing. Reuse source-health qualifications, lifecycle rows, Windows, and fit rows from Tasks 1.5–1.7; do not scaffold the eventual desktop stack as part of Gate 1.
