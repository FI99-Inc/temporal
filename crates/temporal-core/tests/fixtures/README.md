...
- **Explicitly deferred:** lifecycle/recurrence, source-health derivation,
  opportunity/windows, pressure, complete evaluation, and suggestion
  revalidation. Passing this manifest does not claim those later Gate 1 stages.
